...
const themes: Record<DashboardThemeKey, DashboardTheme> = {
  overview: {
    ...
    activeItem: "bg-blue-50 text-blue-800",
    hoverItem: "hover:bg-blue-50 hover:text-blue-800",
    header: "from-blue-700 to-blue-600",
  },
  biomassa: {
    key: "biomassa",
    label: "Biomassa",
    eyebrow: "Energi terbarukan",
    solid: "bg-green-600",
    ...
    activeItem: "bg-green-50 text-green-800",
    hoverItem: "hover:bg-green-50 hover:text-green-800",
  ...
  batubara: {
    ...
    hoverItem: "hover:bg-slate-100 hover:text-slate-800",
    header: "from-slate-700 to-slate-600",
  },
  solar: {
    key: "solar",
    label: "Solar",
    eyebrow: "Bahan bakar pendukung",
    solid: "bg-amber-500",
    ...
    hoverItem: "hover:bg-amber-50 hover:text-amber-800",
  ...
  stok: {
    ...
    hoverItem: "hover:bg-indigo-50 hover:text-indigo-800",
    header: "from-indigo-700 to-indigo-600",
  },
  target: {
    key: "target",
    ...
    activeItem: "bg-violet-50 text-violet-800",
    hoverItem: "hover:bg-violet-50 hover:text-violet-800",
    header: "from-violet-700 to-violet-600",
  },
};
