...
export function UserMenu({ user, theme }: UserMenuProps) {
  ...
  return (
    <details className="group relative">
      <summary className={`flex cursor-pointer list-none items-center gap-2 rounded-xl border border-transparent p-1.5 transition hover:border-slate-200 hover:bg-slate-50 focus:outline-none focus-visible:ring-2 ${theme?.ring ?? "focus-visible:ring-blue-600"}`}>
        <span
          aria-hidden="true"
        ...
        <svg aria-hidden="true" className="hidden size-4 text-slate-400 sm:block" viewBox="0 0 20 20" fill="currentColor">
          <path fillRule="evenodd" d="M5.2 7.4a.75.75 0 0 1 1.06.1L10 11.7l3.74-4.2a.75.75 0 1 1 1.12 1l-4.3 4.85a.75.75 0 0 1-1.12 0l-4.3-4.85a.75.75 0 0 1 .06-1.1Z" clipRule="evenodd" />
        </svg>
      </summary>
