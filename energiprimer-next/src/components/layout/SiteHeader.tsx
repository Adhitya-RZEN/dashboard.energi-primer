    ...
    <header className="sticky top-0 z-20 border-b border-slate-200 bg-white/95 backdrop-blur">
      ...
      <div className="mx-auto flex h-16 max-w-[1600px] items-center gap-3 px-4 sm:gap-4 sm:px-6 lg:px-8">
        ...
        <div className="ml-auto flex shrink-0 items-center gap-2 sm:gap-3">
          <span
            className={`hidden rounded-full px-3 py-1.5 text-xs font-semibold xl:inline-flex ${theme.soft} ${theme.text}`}
          >
            {theme.label}
          </span>
          ...
          <details className="relative lg:hidden">
            <summary
              className={`cursor-pointer list-none rounded-xl border border-slate-200 px-3 py-2 text-sm font-semibold text-slate-700 transition hover:bg-slate-50 focus:outline-none focus-visible:ring-2 ${theme.ring}`}
            >
              Menu
            </summary>
