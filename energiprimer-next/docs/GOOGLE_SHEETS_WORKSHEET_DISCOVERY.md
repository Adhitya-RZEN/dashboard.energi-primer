...
> CURRENT PRODUCTION POINTER (Phase 6V repeat, 2026-09-06): This document remains
> the technical discovery reference. Phase 6K/6L contain the current
> deployment and one controlled Production execution evidence. Phase 6V
> confirms the current artifact and browser state; no further sync is
> authorized here.
